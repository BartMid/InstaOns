...
<div id="login">
<div id="loginl"><h1>Aanmelden</h1></div>
<div id="text"> <input type="text" id="invoer" placeholder="  Gebruikersnaam"/></br>
<input type="text" id="invoer" placeholder="  Wachtwoord"/>
</div>
<input type="button" id="button" value="Aanmelden"/>
<h1 id="heading">Geen account?<A href="registeren.php"><span> Registeren</span></A></h1>
</div>
